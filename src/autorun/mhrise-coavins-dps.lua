...
local ENUM_KEYBOARD_KEY, ENUM_KEYBOARD_MODIFIERS = require("mhrise-coavins-dps.keyboardEnums")(); 	-- The modules export a function, which is executed as soon as it is imported.
local ATTACKER_TYPES, ATTACKER_TYPE_TEXT = require("mhrise-coavins-dps.attackerTypes")();			-- The modules export a function, which is executed as soon as it is imported.
--#endregion
